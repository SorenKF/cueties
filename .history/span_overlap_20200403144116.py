...
# here's a sound snippet to play a beep once this MF has run. The call to play the soudn is at the end
import winsound
...
def main():
    ...
    i = 1
    for filename in os.listdir(parc_directory): #specify which dir you want to run the code on (i.e. which corpus from above)
        if i % 50 == 0:
