...
def add_baseline_info(corpus_test_folder, cues, baseline_path):
    ...
    :parameter: parc_test_folder (path to a corpus test folder)
    ...
    """
    # Add baseline column
    corpus_test_folder = add_baseline_column(parc_test_folder, cues)
...
def run():
    ...
    add_baseline_info(parc_test_folder, polnear_test_folder,
                      cues, baseline_data_path)
